...
public class NotesActivity extends AppCompatActivity {
   ...
   */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Log.w("GPAT:", "log start");
        AdLoad();
        DatabaseReference totalFiles = database.getReference("GPAT/USERS/total");
        totalFiles.addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(DataSnapshot dataSnapshot) {
                ...
                Log.d("GPAT:", "Card1: " + card1);
                Log.d("GPAT:", "Card2: " + card2);
                Log.d("GPAT:", "Card3: " + card3);
                Log.d("GPAT:", "Card4: " + card4);
                Log.d("GPAT:", "Card5: " + card5);
                Log.d("GPAT:", "Card6: " + card6);
                Log.d("GPAT:", "Card7: " + card7);
                Log.d("GPAT:", "Card8: " + card8);
                Log.d("GPAT:", "Card9: " + card9);
                Log.d("GPAT:", "Card10: " + card10);
    ...
    public void collectDataBase() {
        ...
        Log.w("GPAT:", "collect data");


//card1 ----------------------------------------

        //TITLE----
        //   DatabaseReference title = database.getReference("GPAT/USERS/"+card1+"/title");
        DatabaseReference title = database.getReference("GPAT/USERS/" + card1 + "/title");
        ...
        DatabaseReference sub = database.getReference("GPAT/USERS/" + card1 + "/sub");
        ...
        // url
        DatabaseReference downurl = database.getReference("GPAT/USERS/" + card1 + "/url");
        ...
        // username
        DatabaseReference username = database.getReference("GPAT/USERS/" + card1 + "/user");
        ...
        // Doc Type
        DatabaseReference doctype = database.getReference("GPAT/USERS/" + card1 + "/type");
...
//card2 ----------------------------------------
        ...
        //TITLE----
        DatabaseReference title2 = database.getReference("GPAT/USERS/" + card2 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub2 = database.getReference("GPAT/USERS/" + card2 + "/sub");
        ...
        // url
        DatabaseReference downurl2 = database.getReference("GPAT/USERS/" + card2 + "/url");
        ...
        // username
        DatabaseReference username2 = database.getReference("GPAT/USERS/" + card2 + "/user");
        ...
        DatabaseReference doctype2 = database.getReference("GPAT/USERS/" + card2 + "/type");
        ...
        //TITLE----
        DatabaseReference title3 = database.getReference("GPAT/USERS/" + card3 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub3 = database.getReference("GPAT/USERS/" + card3 + "/sub");
        ...
        // url
        DatabaseReference downurl3 = database.getReference("GPAT/USERS/" + card3 + "/url");
        ...
        // username
        DatabaseReference username3 = database.getReference("GPAT/USERS/" + card3 + "/user");
        ...
        DatabaseReference doctype3 = database.getReference("GPAT/USERS/" + card3 + "/type");
        ...
        //TITLE----
        DatabaseReference title4 = database.getReference("GPAT/USERS/" + card4 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub4 = database.getReference("GPAT/USERS/" + card4 + "/sub");
        ...
        // url
        DatabaseReference downurl4 = database.getReference("GPAT/USERS/" + card4 + "/url");
        ...
        // username
        DatabaseReference username4 = database.getReference("GPAT/USERS/" + card4 + "/user");
        ...
        DatabaseReference doctype4 = database.getReference("GPAT/USERS/" + card4 + "/type");
        ...
        //card5 ----------------------------------------
        //TITLE----
        DatabaseReference title5 = database.getReference("GPAT/USERS/" + card5 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub5 = database.getReference("GPAT/USERS/" + card5 + "/sub");
        ...
        // url
        DatabaseReference downurl5 = database.getReference("GPAT/USERS/" + card5 + "/url");
        ...
        // username
        DatabaseReference username5 = database.getReference("GPAT/USERS/" + card5 + "/user");
        ...
        // Doc type
        DatabaseReference doctype5 = database.getReference("GPAT/USERS/" + card5 + "/type");
...
//card6 ----------------------------------------
        //TITLE----
        DatabaseReference title6 = database.getReference("GPAT/USERS/" + card6 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub6 = database.getReference("GPAT/USERS/" + card6 + "/sub");
        ...
        // url
        DatabaseReference downurl6 = database.getReference("GPAT/USERS/" + card6 + "/url");
        ...
        // username
        DatabaseReference username6 = database.getReference("GPAT/USERS/" + card6 + "/user");
        ...
        // Doc type
        DatabaseReference doctype6 = database.getReference("GPAT/USERS/" + card6 + "/type");
        ...
        //card7 ----------------------------------------
        //TITLE----
        DatabaseReference title7 = database.getReference("GPAT/USERS/" + card7 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub7 = database.getReference("GPAT/USERS/" + card7 + "/sub");
        ...
        // url
        DatabaseReference downurl7 = database.getReference("GPAT/USERS/" + card7 + "/url");
        ...
        // username
        DatabaseReference username7 = database.getReference("GPAT/USERS/" + card7 + "/user");
        ...
        // Doc type
        DatabaseReference doctype7 = database.getReference("GPAT/USERS/" + card7 + "/type");
        ...
        //card8 ----------------------------------------
        //TITLE----
        DatabaseReference title8 = database.getReference("GPAT/USERS/" + card8 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub8 = database.getReference("GPAT/USERS/" + card8 + "/sub");
        ...
        // url
        DatabaseReference downurl8 = database.getReference("GPAT/USERS/" + card8 + "/url");
        ...
        // username
        DatabaseReference username8 = database.getReference("GPAT/USERS/" + card8 + "/user");
        ...
        // Doc type
        DatabaseReference doctype8 = database.getReference("GPAT/USERS/" + card8 + "/type");
...
//card9 ----------------------------------------
        //TITLE----
        DatabaseReference title9 = database.getReference("GPAT/USERS/" + card9 + "/title");
        // Read from the database
        ...
        // SUBJECT
        DatabaseReference sub9 = database.getReference("GPAT/USERS/" + card9 + "/sub");
        ...
        // url
        DatabaseReference downurl9 = database.getReference("GPAT/USERS/" + card9 + "/url");
        ...
        // username
        DatabaseReference username9 = database.getReference("GPAT/USERS/" + card9 + "/user");
        ...
        // Doc type
        DatabaseReference doctype9 = database.getReference("GPAT/USERS/" + card9 + "/type");
...
//card10 ----------------------------------------
        //TITLE----
        DatabaseReference title10 = database.getReference("GPAT/USERS/" + card10 + "/title");
        // Read from the database
        ...
        // url
        DatabaseReference downurl10 = database.getReference("GPAT/USERS/" + card10 + "/url");
        ...
        // username
        DatabaseReference username10 = database.getReference("GPAT/USERS/" + card10 + "/user");
        ...
        // Doc type
        DatabaseReference doctype10 = database.getReference("GPAT/USERS/" + card10 + "/type");
    ...
    public void CardVisibility() {
        ...
        Log.d("GPAT:", "Visiblity:---> " + title1text);
        Log.d("GPAT:", "visiblity-----> " + title2text);
